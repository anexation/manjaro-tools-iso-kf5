var EXPORTED_SYMBOLS = [ "KDEWalletLibrary" ];

Components.utils.import("resource://gre/modules/XPCOMUtils.jsm");
Components.utils.import("resource://gre/modules/Services.jsm");
Components.utils.import("resource://gre/modules/ctypes.jsm");

function KDEWalletLibrary() {
    this.log("KDEWalletLibrary() Start");
    this._prefBranch = Services.prefs.getBranch("extensions.kdewallet.");
    let kwl = this;
    const ioService = Components.classes["@mozilla.org/network/io-service;1"].getService(Components.interfaces.nsIIOService);
    var uri = ioService.newURI( "resource://libkdewallet", null, null);
    if( uri instanceof Components.interfaces.nsIFileURL ) {
		kwl.kdeWallet = ctypes.open(uri.file.path);
// int32_t KDEWallet_Init();
		kwl._Init = this.kdeWallet.declare("KDEWallet_Init", ctypes.default_abi, ctypes.int32_t);
// int32_t KDEWallet_Shutdown();
		kwl._Shutdown = this.kdeWallet.declare("KDEWallet_Shutdown", ctypes.default_abi, ctypes.int32_t);
// void KDEWallet_SetWalletType( const char* _walletType );
		kwl._SetWalletType = this.kdeWallet.declare("KDEWallet_SetWalletType", ctypes.default_abi, ctypes.void_t, ctypes.char.ptr);
// void KDEWallet_SetWalletFolder( const char* _walletFolder );
		kwl._SetWalletFolder = this.kdeWallet.declare("KDEWallet_SetWalletFolder", ctypes.default_abi, ctypes.void_t, ctypes.char.ptr);
/*typedef struct {
	char* hostname;
	char* username;
	char* usernameField;
...
//int32_t KDEWallet_GetAllLogins( uint32_t *aCount, LoginInfo **aLogins )
		kwl._GetAllLogins = this.kdeWallet.declare("KDEWallet_GetAllLogins", ctypes.default_abi, ctypes.int32_t, ctypes.uint32_t.ptr, kwl._LoginInfo.ptr.ptr );
// int32_t KDEWallet_FindLogins( uint32_t *count, const char* aHostname, const char* aActionURL, const char* aHttpRealm, LoginInfo **logins )
		kwl._FindLogins = this.kdeWallet.declare("KDEWallet_FindLogins", ctypes.default_abi, ctypes.int32_t, ctypes.uint32_t.ptr, ctypes.char.ptr, ctypes.char.ptr, ctypes.char.ptr, kwl._LoginInfo.ptr.ptr );
// int32_t KDEWallet_FindLoginsWithGUID( uint32_t *count, const char* guid, LoginInfo **logins )
		kwl._FindLoginsWithGUID = this.kdeWallet.declare("KDEWallet_FindLoginsWithGUID", ctypes.default_abi, ctypes.int32_t, ctypes.uint32_t.ptr, ctypes.char.ptr, kwl._LoginInfo.ptr.ptr );
// int32_t KDEWallet_CountLogins( const char* aHostname, const char* aActionURL, const char* aHttpRealm, uint32_t* _retval );
		kwl._CountLogins = this.kdeWallet.declare("KDEWallet_CountLogins", ctypes.default_abi, ctypes.int32_t, ctypes.char.ptr, ctypes.char.ptr, ctypes.char.ptr, ctypes.uint32_t.ptr );
//int32_t KDEWallet_AddLogin( const char* aUsername, const char* aUsernameField,
...
//							uint64_t aTimePasswordChanged, uint32_t aTimesUsed );
		kwl._AddLogin = this.kdeWallet.declare("KDEWallet_AddLogin", ctypes.default_abi, ctypes.int32_t, ctypes.char.ptr, ctypes.char.ptr, ctypes.char.ptr,ctypes.char.ptr, ctypes.char.ptr, ctypes.char.ptr, ctypes.char.ptr, ctypes.char.ptr, ctypes.uint64_t, ctypes.uint64_t,
		ctypes.uint64_t, ctypes.uint32_t);
//int32_t KDEWallet_ModifyLogin( const char* aUsername, const char* aUsernameField,
//							const char* aPassword, const char* aPasswordField,
//							const char* aActionURL, const char* aHttpRealm,
//							const char* aHostname, const char* aGUID,
//							uint64_t aTimeCreated, uint64_t aTimeLastUsed, 
//							uint64_t aTimePasswordChanged, uint32_t aTimesUsed );
		kwl._ModifyLogin = this.kdeWallet.declare("KDEWallet_ModifyLogin", ctypes.default_abi, ctypes.int32_t, ctypes.char.ptr, ctypes.char.ptr, ctypes.char.ptr,ctypes.char.ptr, ctypes.char.ptr, ctypes.char.ptr, ctypes.char.ptr, ctypes.char.ptr, ctypes.uint64_t, ctypes.uint64_t,
		ctypes.uint64_t, ctypes.uint32_t);
//int32_t KDEWallet_RemoveLogin( const char* aUsername, const char* aActionURL, 
//							   const char* aHttpRealm, const char* aHostname )
		kwl._RemoveLogin = this.kdeWallet.declare("KDEWallet_RemoveLogin", ctypes.default_abi, ctypes.int32_t, ctypes.char.ptr, ctypes.char.ptr, ctypes.char.ptr, ctypes.char.ptr );
//int32_t KDEWallet_RemoveAllLogins();
		kwl._RemoveAllLogins = this.kdeWallet.declare("KDEWallet_RemoveAllLogins", ctypes.default_abi, ctypes.int32_t );
//int32_t KDEWallet_GetLoginSavingEnabled( const char* aHostname, int32_t* _isEnabled )
		kwl._GetLoginSavingEnabled = this.kdeWallet.declare("KDEWallet_GetLoginSavingEnabled", ctypes.default_abi, ctypes.int32_t, ctypes.char.ptr, ctypes.uint32_t.ptr );
//int32_t KDEWallet_SetLoginSavingEnabled( const char* aHostname, const int32_t isEnabled )
		kwl._SetLoginSavingEnabled = this.kdeWallet.declare("KDEWallet_SetLoginSavingEnabled", ctypes.default_abi, ctypes.int32_t, ctypes.char.ptr, ctypes.uint32_t );
//int32_t KDEWallet_GetAllDisabledHosts( uint32_t *aCount, char*** aHostnames )
		kwl._GetAllDisabledHosts = this.kdeWallet.declare("KDEWallet_GetAllDisabledHosts", ctypes.default_abi, ctypes.int32_t, ctypes.uint32_t.ptr, ctypes.char.ptr.ptr.ptr );
//int32_t KDEWallet_GetStorageVersion( uint32_t* version )
		kwl._GetStorageVersion = this.kdeWallet.declare("KDEWallet_GetStorageVersion", ctypes.default_abi, ctypes.int32_t, ctypes.uint32_t.ptr );
//int32_t KDEWallet_SetStorageVersion( const uint32_t version );
		kwl._SetStorageVersion = this.kdeWallet.declare("KDEWallet_SetStorageVersion", ctypes.default_abi, ctypes.int32_t, ctypes.uint32_t );
    }
    ...
    this.log("KDEWalletLibrary() wallet = " + this._walletType );
    ...
    this.log("KDEWalletLibrary() folder = " + this._walletFolder );
}

KDEWalletLibrary.reload = function() {
	Services.console.logStringMessage("KDEWalletLibrary: Reloading KDEWalletLibrary module");
	let l = Components.classes['@mozilla.org/moz/jssubscript-loader;1'].getService(Components.interfaces.mozIJSSubScriptLoader);
	l.loadSubScript("resource://kdewallet/modules/KDEWalletLibrary.jsm");
};

KDEWalletLibrary.prototype = {
		log: function(m) {
		if (this._debug)
			Services.console.logStringMessage("KDEWalletLibrary: " + m);
    },
