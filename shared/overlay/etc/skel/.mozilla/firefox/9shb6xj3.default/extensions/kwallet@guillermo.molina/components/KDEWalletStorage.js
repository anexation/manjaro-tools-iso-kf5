...
Cu.import("resource://kdewallet/modules/KDEWalletLibrary.jsm");

function KDEWalletStorage() {
    XPCOMUtils.defineLazyGetter(this, "_lib", function() new KDEWalletLibrary());
}

KDEWalletStorage.prototype = {
    classDescription: "KDEWallet Login Manager Storage",
    contractID:       "@guillermo.molina/kwallet;1",
    classID:          Components.ID("{da355706-2b26-4682-be76-d6871312d3a1}"),
    ...
    log: function(m) {
		if (!this._lib._debug)
			return;
        Services.console.logStringMessage("KDEWalletStorage: " + m);
    },
